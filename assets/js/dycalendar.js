(function (global) {
    ...
    function drawCalendarMonthTable(data, option) {
        ...
        if (option.prevnextbutton === "show") {
            ...
            elem.innerHTML = '<img src="/prev.svg">';
        ...
        if (option.prevnextbutton === "show") {
            ...
            elem.innerHTML = '<img src="/next.svg">';
            //add prev button span to header div
            div.appendChild(elem);
        }
    ...
    function drawCalendarDay(data, option) {
        ...
        elem.setAttribute("class", "dycalendar-h3-day");
        if (option.dayformat === "ddd") {
            elem.innerHTML = dayName.ddd[data.targetedDayIndex] + ', ' + data.date + ' ' + data.monthNameFull;
        } else if (option.dayformat === "full") {
            elem.innerHTML = dayName.full[data.targetedDayIndex] + ', ' + data.date + ' ' + data.monthNameFull;
        }
        // // opcao para colocar o ano junto com o mes
        // // elem.innerHTML = data.monthName + " " + data.year;

        //add day h3 to footer div
        div.appendChild(elem);
